...
echo Do you wish to legaly crack filmora 9? [(y)es/(n)o/(d)ebug]:
set /p choice=
if %choice%==y goto y
if %choice%==Y goto y
if %choice%==n goto n
...
echo.
echo If these previous steps are validated checke the second steps.
echo.
echo 2. Check that you're current disk is labeled (C:) If this is no the case replace the letter c (in the line "c:\Program Files\Wondershare\Filmora9" by the lowercase letter of your disk in which the program is)
...
echo.
echo PS: To find the folder, wrigt click on the icon on your desktop --> reveal in explorer, repeat this action with the icon in the folder in which you'lle be if you do not see more than the shortcuts to Uninstall Wondershare Filmora9 and Wondershare Filmora9.
echo.
